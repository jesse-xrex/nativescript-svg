[![npm](https://img.shields.io/npm/v/@jnorkus/nativescript-svg.svg)](https://www.npmjs.com/package/@jnorkus/nativescript-svg)
[![npm](https://img.shields.io/npm/dt/@jnorkus/nativescript-svg.svg?label=npm%20downloads)](https://www.npmjs.com/package/@jnorkus/nativescript-svg)
...
`tns plugin add @jnorkus/nativescript-svg`
...
```js
var ImageSourceSVGModule = require('@jnorkus/nativescript-svg');
...
<Page xmlns="http://schemas.nativescript.org/tns.xsd"
      xmlns:svg="@jnorkus/nativescript-svg" loaded="pageLoaded">
  <StackLayout>
    <!--svg image tag-->
